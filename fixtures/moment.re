external moment : moment.MomentInput.t? => moment.MomentFormatSpecification.t? => bool? => (unit [@bs.ignore]) => moment.Moment.t = "" [@@bs.module "moment"];
external moment : moment.MomentInput.t? => moment.MomentFormatSpecification.t? => string? => bool? => (unit [@bs.ignore]) => moment.Moment.t = "" [@@bs.module "moment"];
let module Moment = {

  external utc : MomentInput.t? => MomentFormatSpecification.t? => bool? => (unit [@bs.ignore]) => Moment.t = "" [@@bs.module "moment"];
  external utc : MomentInput.t? => MomentFormatSpecification.t? => string? => bool? => (unit [@bs.ignore]) => Moment.t = "" [@@bs.module "moment"];
  external unix : float => Moment.t = "" [@@bs.module "moment"];
  external invalid : MomentParsingFlagsOpt.t? => (unit [@bs.ignore]) => Moment.t = "" [@@bs.module "moment"];
  external isMoment : 'Any => bool = "" [@@bs.module "moment"];
  external isDate : 'Any => bool = "" [@@bs.module "moment"];
  external isDuration : 'Any => bool = "" [@@bs.module "moment"];
  external lang : string? => (unit [@bs.ignore]) => string = "" [@@bs.module "moment"];
  external lang : string? => Locale.t? => (unit [@bs.ignore]) => string = "" [@@bs.module "moment"];
  external locale : string? => (unit [@bs.ignore]) => string = "" [@@bs.module "moment"];
  external locale : (array string)? => (unit [@bs.ignore]) => string = "" [@@bs.module "moment"];
  external locale : string? => (definitionType 'a [@bs.ignore]) => 'a? => (unit [@bs.ignore]) => string = "" [@@bs.module "moment"];
  external localeData : (keyType 'a [@bs.ignore]) => 'a? => (unit [@bs.ignore]) => Locale.t = "" [@@bs.module "moment"];
  external duration : DurationInputArg1.t? => DurationInputArg2.t? => (unit [@bs.ignore]) => Duration.t = "" [@@bs.module "moment"];
  external parseZone : MomentInput.t? => MomentFormatSpecification.t? => bool? => (unit [@bs.ignore]) => Moment.t = "" [@@bs.module "moment"];
  external parseZone : MomentInput.t? => MomentFormatSpecification.t? => string? => bool? => (unit [@bs.ignore]) => Moment.t = "" [@@bs.module "moment"];
  external months : unit => (array string) = "" [@@bs.module "moment"];
  external months : float => string = "" [@@bs.module "moment"];
  external months : string => (array string) = "" [@@bs.module "moment"];
  external months : string => float => string = "" [@@bs.module "moment"];
  external monthsShort : unit => (array string) = "" [@@bs.module "moment"];
  external monthsShort : float => string = "" [@@bs.module "moment"];
  external monthsShort : string => (array string) = "" [@@bs.module "moment"];
  external monthsShort : string => float => string = "" [@@bs.module "moment"];
  external weekdays : unit => (array string) = "" [@@bs.module "moment"];
  external weekdays : float => string = "" [@@bs.module "moment"];
  external weekdays : string => (array string) = "" [@@bs.module "moment"];
  external weekdays : string => float => string = "" [@@bs.module "moment"];
  external weekdays : bool => (array string) = "" [@@bs.module "moment"];
  external weekdays : bool => float => string = "" [@@bs.module "moment"];
  external weekdays : bool => string => (array string) = "" [@@bs.module "moment"];
  external weekdays : bool => string => float => string = "" [@@bs.module "moment"];
  external weekdaysShort : unit => (array string) = "" [@@bs.module "moment"];
  external weekdaysShort : float => string = "" [@@bs.module "moment"];
  external weekdaysShort : string => (array string) = "" [@@bs.module "moment"];
  external weekdaysShort : string => float => string = "" [@@bs.module "moment"];
  external weekdaysShort : bool => (array string) = "" [@@bs.module "moment"];
  external weekdaysShort : bool => float => string = "" [@@bs.module "moment"];
  external weekdaysShort : bool => string => (array string) = "" [@@bs.module "moment"];
  external weekdaysShort : bool => string => float => string = "" [@@bs.module "moment"];
  external weekdaysMin : unit => (array string) = "" [@@bs.module "moment"];
  external weekdaysMin : float => string = "" [@@bs.module "moment"];
  external weekdaysMin : string => (array string) = "" [@@bs.module "moment"];
  external weekdaysMin : string => float => string = "" [@@bs.module "moment"];
  external weekdaysMin : bool => (array string) = "" [@@bs.module "moment"];
  external weekdaysMin : bool => float => string = "" [@@bs.module "moment"];
  external weekdaysMin : bool => string => (array string) = "" [@@bs.module "moment"];
  external weekdaysMin : bool => string => float => string = "" [@@bs.module "moment"];
  external min : (array MomentInput.t) => Moment.t = "" [@@bs.module "moment"];
  external max : (array MomentInput.t) => Moment.t = "" [@@bs.module "moment"];
  external now : unit => float = "" [@@bs.module "moment"];
  external defineLocale : string => (localeSpecType 'a [@bs.ignore]) => 'a => Locale.t = "" [@@bs.module "moment"];
  external updateLocale : string => (localeSpecType 'a [@bs.ignore]) => 'a => Locale.t = "" [@@bs.module "moment"];
  external locales : unit => (array string) = "" [@@bs.module "moment"];
  external normalizeUnits : unitOfTime.All.t => string = "" [@@bs.module "moment"];
  external relativeTimeThreshold : string => relativeTimeThresholdType = "" [@@bs.module "moment"];
  external relativeTimeThreshold : string => float => bool = "" [@@bs.module "moment"];
  external relativeTimeRounding : (float => float [@bs.uncurry]) => bool = "" [@@bs.module "moment"];
  external relativeTimeRounding : unit => (float => float [@bs.uncurry]) = "" [@@bs.module "moment"];
  external calendarFormat : Moment.t => Moment.t => string = "" [@@bs.module "moment"];
