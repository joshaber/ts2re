module electron = {
  ...
  module Window = {
    ...
    external open : t => string => ?frameName::string => ?features::string => Electron.BrowserWindowProxy.t = "" [@@bs.send];
  };

  module File = {
    type t;

    external make : path::string => unit => t = "" [@@bs.obj]
  ...
  module Electron = {
    ...
    type browserWindowTypeMac = {
    };

    type browserWindowTypeWindows = {
    };
    ...
    module Event = {
      ...
      external make : preventDefault::(<..> => <..>) => sender::NodeJS.EventEmitter.t => unit => t = "" [@@bs.obj]
    ...
    module App = {
      ...
      external make : commandLine::CommandLine.t => dock::Dock.t => unit => t = "" [@@bs.obj]
      ...
      external exit : t => ?exitCode::float => unit = "" [@@bs.send];
      external relaunch : t => ?options::'a => unit = "" [@@bs.send];
      ...
      external setAsDefaultProtocolClient : t => string => ?path::string => ?args::array string => bool = "" [@@bs.send];
      external removeAsDefaultProtocolClient : t => string => ?path::string => ?args::array string => bool = "" [@@bs.send];
      external isDefaultProtocolClient : t => string => ?path::string => ?args::array string => bool = "" [@@bs.send];
      ...
      external setUserActivity : t => string => Object.t => ?webpageURL::string => unit = "" [@@bs.send];
    ...
    module ImportCertificateOptions = {
      type t;

      external make : certificate::string => password::string => unit => t = "" [@@bs.obj]
    ...
    module CommandLine = {
      ...
      external appendSwitch : t => string => ?value::string => unit = "" [@@bs.send];
    ...
    module Dock = {
      ...
      external bounce : t => ?type::U2<'a, 'a> => float = "" [@@bs.send];
    ...
    module JumpListSettings = {
      type t;

      external make : minItems::float => removedItems::array JumpListItem.t => unit => t = "" [@@bs.obj]
    ...
    module AutoUpdater = {
      ...
      external on : t => string => (<..> => <..>) => t = "" [@@bs.send];
      external setFeedURL : t => string => ?requestHeaders::Headers.t => unit = "" [@@bs.send];
    ...
    module BrowserWindow = {
      ...
      external make : webContents::WebContents.t => id::float => unit => t = "" [@@bs.obj]
      ...
      external setAspectRatio : t => float => ?extraSize::Size.t => unit = "" [@@bs.send];
      external previewFile : t => string => ?displayName::string => unit = "" [@@bs.send];
      external setBounds : t => Rectangle.t => ?animate::bool => unit = "" [@@bs.send];
      external getBounds : t => Rectangle.t = "" [@@bs.send];
      external setContentBounds : t => Rectangle.t => ?animate::bool => unit = "" [@@bs.send];
      external getContentBounds : t => Rectangle.t = "" [@@bs.send];
      external setSize : t => float => float => ?animate::bool => unit = "" [@@bs.send];
      external getSize : t => array float = "" [@@bs.send];
      external setContentSize : t => float => float => ?animate::bool => unit = "" [@@bs.send];
      ...
      external loadURL : t => string => ?options::LoadURLOptions.t => unit = "" [@@bs.send];
      external reload : t => unit = "" [@@bs.send];
      external setMenu : t => U2<Menu.t, 'a> => unit = "" [@@bs.send];
      external setProgressBar : t => float => ?options::'a => unit = "" [@@bs.send];
    ...
    module DevToolsExtensions = {
      type t;

      external make : Item::'a => unit => t = "" [@@bs.obj]
    ...
    module Clipboard = {
      ...
      external readText : t => ?type::ClipboardType.t => string = "" [@@bs.send];
      external writeText : t => string => ?type::ClipboardType.t => unit = "" [@@bs.send];
      external readHTML : t => ?type::ClipboardType.t => string = "" [@@bs.send];
      external writeHTML : t => string => ?type::ClipboardType.t => unit = "" [@@bs.send];
      external readImage : t => ?type::ClipboardType.t => NativeImage.t = "" [@@bs.send];
      external writeImage : t => NativeImage.t => ?type::ClipboardType.t => unit = "" [@@bs.send];
      external readRTF : t => ?type::ClipboardType.t => string = "" [@@bs.send];
      external writeRTF : t => string => ?type::ClipboardType.t => unit = "" [@@bs.send];
      external clear : t => ?type::ClipboardType.t => unit = "" [@@bs.send];
      external availableFormats : t => ?type::ClipboardType.t => array string = "" [@@bs.send];
      external has : t => string => ?type::ClipboardType.t => bool = "" [@@bs.send];
      external read : t => string => ?type::ClipboardType.t => U2<string, NativeImage.t> = "" [@@bs.send];
      external write : t => U4<'a, 'a, 'a, 'a> => ?type::ClipboardType.t => unit = "" [@@bs.send];
      external readBookmark : t => Bookmark.t = "" [@@bs.send];
      external writeBookmark : t => string => string => ?type::ClipboardType.t => unit = "" [@@bs.send];
    ...
    module Bookmark = {
      ...
      external make : title::string => url::string => unit => t = "" [@@bs.obj]
    ...
    module ContentTracingOptions = {
      type t;

      external make : categoryFilter::string => traceOptions::string => unit => t = "" [@@bs.obj]
    ...
    module CrashReporterStartOptions = {
      type t;
    ...
    module CrashReport = {
      ...
      external make : id::string => date::Date.t => unit => t = "" [@@bs.obj]
    ...
    module DesktopCapturerSource = {
      type t;

      external make : id::string => name::string => thumbnail::NativeImage.t => unit => t = "" [@@bs.obj]
    ...
    module Dialog = {
      ...
      external showOpenDialog : t => BrowserWindow.t => OpenDialogOptions.t => ?callback::(array string => unit) => array string = "" [@@bs.send];
      external showOpenDialog : t => OpenDialogOptions.t => ?callback::(array string => unit) => array string = "" [@@bs.send];
      external showSaveDialog : t => BrowserWindow.t => SaveDialogOptions.t => ?callback::(string => unit) => string = "" [@@bs.send];
      external showSaveDialog : t => SaveDialogOptions.t => ?callback::(string => unit) => string = "" [@@bs.send];
      external showMessageBox : t => BrowserWindow.t => ShowMessageBoxOptions.t => ?callback::(float => unit) => float = "" [@@bs.send];
      external showMessageBox : t => ShowMessageBoxOptions.t => ?callback::(float => unit) => float = "" [@@bs.send];
    ...
    module IpcMain = {
      ...
      external removeAllListeners : t => ?channel::string => t = "" [@@bs.send];
    };
    ...
    module IpcRendererEvent = {
      type t;

      external make : sender::IpcRenderer.t => unit => t = "" [@@bs.obj]
    ...
    module MenuItem = {
      ...
      external make : click::(Event.t => BrowserWindow.t => WebContents.t => unit) => type::MenuItemType.t => role::U2<MenuItemRole.t, MenuItemRoleMac.t> => accelerator::string => icon::U2<NativeImage.t, string> => submenu::U2<Menu.t, array MenuItemOptions.t> => label::string => sublabel::string => enabled::bool => visible::bool => checked::bool => unit => t = "" [@@bs.obj]
    ...
    module Menu = {
      ...
      external make : items::array MenuItem.t => unit => t = "" [@@bs.obj]
      ...
      external popup : t => ?browserWindow::BrowserWindow.t => ?x::float => ?y::float => unit = "" [@@bs.send];
    ...
    module NativeImage = {
      ...
      external createFromBuffer : t => Buffer.t => ?scaleFactor::float => NativeImage.t = "" [@@bs.send];
    ...
    module Net = {
      ...
      external request : t => U2<string, RequestOptions.t> => ?callback::(IncomingMessage.t => unit) => ClientRequest.t = "" [@@bs.send];
    };
    ...
    module ClientRequest = {
      ...
      external make : chunkedEncoding::bool => unit => t = "" [@@bs.obj]
      ...
      external write : t => U2<string, Buffer.t> => ?encoding::string => ?callback::(<..> => <..>) => bool = "" [@@bs.send];
      external end : t => ?chunk::U2<string, Buffer.t> => ?encoding::string => ?callback::(<..> => <..>) => bool = "" [@@bs.send];
    ...
    module IncomingMessage = {
      ...
      external make : statusCode::float => statusMessage::string => headers::'a => httpVersion::string => httpVersionMajor::float => httpVersionMinor::float => unit => t = "" [@@bs.obj]
    ...
    module Protocol = {
      ...
      external registerFileProtocol : t => string => FileProtocolHandler.t => ?completion::(Error.t => unit) => unit = "" [@@bs.send];
      external registerBufferProtocol : t => string => BufferProtocolHandler.t => ?completion::(Error.t => unit) => unit = "" [@@bs.send];
      external registerStringProtocol : t => string => StringProtocolHandler.t => ?completion::(Error.t => unit) => unit = "" [@@bs.send];
      external registerHttpProtocol : t => string => HttpProtocolHandler.t => ?completion::(Error.t => unit) => unit = "" [@@bs.send];
      external unregisterProtocol : t => string => ?completion::(Error.t => unit) => unit = "" [@@bs.send];
      external isProtocolHandled : t => string => (bool => unit) => unit = "" [@@bs.send];
      external interceptFileProtocol : t => string => FileProtocolHandler.t => ?completion::(Error.t => unit) => unit = "" [@@bs.send];
      external interceptBufferProtocol : t => string => BufferProtocolHandler.t => ?completion::(Error.t => unit) => unit = "" [@@bs.send];
      external interceptStringProtocol : t => string => StringProtocolHandler.t => ?completion::(Error.t => unit) => unit = "" [@@bs.send];
      external interceptHttpProtocol : t => string => HttpProtocolHandler.t => ?completion::(Error.t => unit) => unit = "" [@@bs.send];
      external uninterceptProtocol : t => string => ?completion::(Error.t => unit) => unit = "" [@@bs.send];
    };
    ...
    module Remote = {
      ...
      external make : process::NodeJS.Process.t => unit => t = "" [@@bs.obj]
    ...
    module Display = {
      ...
      external make : id::float => bounds::Rectangle.t => workArea::Rectangle.t => size::Size.t => workAreaSize::Size.t => scaleFactor::float => rotation::float => touchSupport::U3<'a, 'a, 'a> => unit => t = "" [@@bs.obj]
    ...
    module Session = {
      ...
      external make : defaultSession::Session.t => cookies::SessionCookies.t => webRequest::WebRequest.t => protocol::Protocol.t => unit => t = "" [@@bs.obj]

      external fromPartition : t => string => ?options::FromPartitionOptions.t => Session.t = "" [@@bs.send];
      ...
      external setUserAgent : t => string => ?acceptLanguages::string => unit = "" [@@bs.send];
    ...
    module ClearStorageDataOptions = {
      type t;
    ...
    module ProxyConfig = {
      ...
      external make : pacScript::string => proxyRules::string => proxyBypassRules::string => unit => t = "" [@@bs.obj]
    ...
    module NetworkEmulationOptions = {
      type t;
    ...
    module Shell = {
      ...
      external openExternal : t => string => ?options::'a => bool = "" [@@bs.send];
    ...
    module Tray = {
      ...
      external displayBalloon : t => ?options::'a => unit = "" [@@bs.send];
      external popUpContextMenu : t => ?menu::Menu.t => ?position::Point.t => unit = "" [@@bs.send];
    ...
    module Modifiers = {
      ...
      external make : altKey::bool => shiftKey::bool => ctrlKey::bool => metaKey::bool => unit => t = "" [@@bs.obj]
    ...
    module DragItem = {
      ...
      external make : file::string => icon::NativeImage.t => unit => t = "" [@@bs.obj]
    ...
    module WebContents = {
      ...
      external make : id::float => session::Session.t => hostWebContents::WebContents.t => devToolsWebContents::WebContents.t => debugger::Debugger.t => unit => t = "" [@@bs.obj]
      ...
      external executeJavaScript : t => string => ?userGesture::bool => ?callback::('a => unit) => Promise.t<'a> = "" [@@bs.send];
      ...
      external findInPage : t => string => ?options::FindInPageOptions.t => float = "" [@@bs.send];
      ...
      external print : t => ?options::PrintOptions.t => unit = "" [@@bs.send];
      ...
      external openDevTools : t => ?options::'a => unit = "" [@@bs.send];
      ...
      external savePage : t => string => U3<'a, 'a, 'a> => ?callback::(Error.t => unit) => bool = "" [@@bs.send];
      external showDefinitionForSelection : t => unit = "" [@@bs.send];
    ...
    module BeginFrameSubscriptionCallback = {
      type t;

      external invoke : t => Buffer.t => ?dirtyRect::Rectangle.t => unit = "" [@@bs.send];
    };

    module ContextMenuParams = {
      type t;
    ...
    module BluetoothDevice = {
      ...
      external make : deviceName::string => deviceId::string => unit => t = "" [@@bs.obj]
    ...
    module Headers = {
      ...
      external make : Item::string => unit => t = "" [@@bs.obj]
    ...
    module UploadRawData = {
      type t;

      external make : type::'a => bytes::Buffer.t => unit => t = "" [@@bs.obj]
    ...
    module UploadFileSystem = {
      type t;

      external make : type::'a => fileSystemURL::string => offset::float => length::float => modificationTime::float => unit => t = "" [@@bs.obj]
    ...
    module UploadBlob = {
      ...
      external make : type::'a => blobUUID::string => unit => t = "" [@@bs.obj]
    ...
    module Certificate = {
      ...
      external make : data::string => issuer::CertificatePrincipal.t => issuerName::string => issuerCert::Certificate.t => subject::CertificatePrincipal.t => subjectName::string => serialNumber::string => validStart::float => validExpiry::float => fingerprint::string => unit => t = "" [@@bs.obj]
    ...
    module CertificatePrincipal = {
      ...
      external make : commonName::string => organizations::array string => organizationUnits::array string => locality::string => state::string => country::string => unit => t = "" [@@bs.obj]
    ...
    module LoginRequest = {
      ...
      external make : method::string => url::string => referrer::string => unit => t = "" [@@bs.obj]
    ...
    module LoginAuthInfo = {
      type t;

      external make : isProxy::bool => scheme::string => host::string => port::float => realm::string => unit => t = "" [@@bs.obj]
    ...
    module DeviceEmulationParameters = {
      type t;
    ...
    module SendInputEvent = {
      type t;

      external make : type::obj => modifiers::array obj => unit => t = "" [@@bs.obj]
    ...
    module SendInputKeyboardEvent = {
      type t;

      external make : keyCode::string => unit => t = "" [@@bs.obj]
    ...
    module SendInputMouseWheelEvent = {
      type t;
    ...
    module Debugger = {
      ...
      external attach : t => ?protocolVersion::string => unit = "" [@@bs.send];
      external isAttached : t => bool = "" [@@bs.send];
      external detach : t => unit = "" [@@bs.send];
      external sendCommand : t => string => ?commandParams::'a => ?callback::(Error.t => 'a => unit) => unit = "" [@@bs.send];
      external on : t => 'a => (Event.t => string => unit) => t = "" [@@bs.send];
    ...
    module WebFrame = {
      ...
      external registerURLSchemeAsPrivileged : t => string => ?options::RegisterURLSchemeOptions.t => unit = "" [@@bs.send];
      external insertText : t => string => unit = "" [@@bs.send];
      external executeJavaScript : t => string => ?userGesture::bool => ?callback::('a => unit) => Promise.t<'a> = "" [@@bs.send];
    ...
    module ResourceUsages = {
      type t;

      external make : fonts::ResourceUsage.t => images::ResourceUsage.t => cssStyleSheets::ResourceUsage.t => xslStyleSheets::ResourceUsage.t => scripts::ResourceUsage.t => other::ResourceUsage.t => unit => t = "" [@@bs.obj]
    ...
    module ResourceUsage = {
      ...
      external make : count::float => decodedSize::float => liveSize::float => purgeableSize::float => purgedSize::float => size::float => unit => t = "" [@@bs.obj]
    ...
    module RegisterURLSchemeOptions = {
      type t;
    ...
    module WebViewElement = {
      ...
      external make : src::string => autosize::string => nodeintegration::string => plugins::string => preload::string => httpreferrer::string => useragent::string => disablewebsecurity::string => partition::string => allowpopups::string => webpreferences::string => blinkfeatures::string => disableblinkfeatures::string => guestinstance::string => unit => t = "" [@@bs.obj]
      ...
      external capturePage : t => (NativeImage.t => unit) => unit = "" [@@bs.send];
      external capturePage : t => Rectangle.t => (NativeImage.t => unit) => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.LoadCommitEvent.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.Event.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.DidFailLoadEvent.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.DidFrameFinishLoadEvent.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.Event.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.Event.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.DidGetResponseDetails.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.DidGetRedirectRequestEvent.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.Event.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.PageTitleUpdatedEvent.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.PageFaviconUpdatedEvent.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.Event.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.Event.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.ConsoleMessageEvent.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.FoundInPageEvent.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.NewWindowEvent.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.WillNavigateEvent.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.DidNavigateEvent.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.DidNavigateInPageEvent.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.Event.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.IpcMessageEvent.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.Event.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.Event.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.PluginCrashedEvent.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.Event.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.Event.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.Event.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.DidChangeThemeColorEvent.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.UpdateTargetUrlEvent.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.Event.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.Event.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => 'a => (WebViewElement.Event.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
      external addEventListener : t => string => (WebViewElement.Event.t => unit) => ?useCapture::bool => unit = "" [@@bs.send];
    ...
    module BrowserWindowProxy = {
      type t;

      external make : closed::bool => unit => t = "" [@@bs.obj]
    ...
    module ElectronMainAndRenderer = {
      type t;

      external make : desktopCapturer::Electron.DesktopCapturer.t => ipcRenderer::Electron.IpcRenderer.t => remote::Electron.Remote.t => webFrame::Electron.WebFrame.t => unit => t = "" [@@bs.obj]
    ...
    module WebRequest = {
      ...
      module Filter = {
        ...
        external make : urls::array string => unit => t = "" [@@bs.obj]
      ...
      module Details = {
        ...
        external make : id::float => url::string => method::string => resourceType::string => timestamp::float => unit => t = "" [@@bs.obj]
      ...
      module UploadData = {
        ...
        external make : bytes::Buffer.t => file::string => blobUUID::string => unit => t = "" [@@bs.obj]
      ...
      module BeforeSendHeadersDetails = {
        type t;

        external make : requestHeaders::Headers.t => unit => t = "" [@@bs.obj]
      ...
      module HeadersReceivedDetails = {
        type t;

        external make : statusLine::string => statusCode::float => responseHeaders::Headers.t => unit => t = "" [@@bs.obj]
      ...
      module ResponseStartedDetails = {
        type t;

        external make : responseHeaders::Headers.t => fromCache::bool => statusCode::float => statusLine::string => unit => t = "" [@@bs.obj]
      ...
      module ErrorOccurredDetails = {
        type t;

        external make : fromCache::bool => error::string => unit => t = "" [@@bs.obj]
    ...
    module WebViewElement = {
      ...
      module LoadCommitEvent = {
        type t;

        external make : url::string => isMainFrame::bool => unit => t = "" [@@bs.obj]
      ...
      module DidFailLoadEvent = {
        type t;

        external make : errorCode::float => errorDescription::string => validatedURL::string => isMainFrame::bool => unit => t = "" [@@bs.obj]
      ...
      module DidFrameFinishLoadEvent = {
        type t;

        external make : isMainFrame::bool => unit => t = "" [@@bs.obj]
      ...
      module DidGetResponseDetails = {
        type t;

        external make : status::bool => newURL::string => originalURL::string => httpResponseCode::float => requestMethod::string => referrer::string => headers::Headers.t => resourceType::string => unit => t = "" [@@bs.obj]
      ...
      module DidGetRedirectRequestEvent = {
        type t;

        external make : oldURL::string => newURL::string => isMainFrame::bool => httpResponseCode::float => requestMethod::string => referrer::string => headers::Headers.t => unit => t = "" [@@bs.obj]
      ...
      module PageTitleUpdatedEvent = {
        type t;

        external make : title::string => explicitSet::string => unit => t = "" [@@bs.obj]
      ...
      module PageFaviconUpdatedEvent = {
        type t;

        external make : favicons::array string => unit => t = "" [@@bs.obj]
      ...
      module ConsoleMessageEvent = {
        type t;

        external make : level::float => message::string => line::float => sourceId::string => unit => t = "" [@@bs.obj]
      ...
      module FoundInPageEvent = {
        type t;

        external make : result::FoundInPageResult.t => unit => t = "" [@@bs.obj]
      ...
      module NewWindowEvent = {
        type t;

        external make : url::string => frameName::string => disposition::NewWindowDisposition.t => options::BrowserWindowOptions.t => unit => t = "" [@@bs.obj]
      ...
      module WillNavigateEvent = {
        type t;

        external make : url::string => unit => t = "" [@@bs.obj]
      ...
      module IpcMessageEvent = {
        type t;

        external make : channel::string => args::array 'a => unit => t = "" [@@bs.obj]
      ...
      module PluginCrashedEvent = {
        type t;

        external make : name::string => version::string => unit => t = "" [@@bs.obj]
      ...
      module DidChangeThemeColorEvent = {
        type t;

        external make : themeColor::string => unit => t = "" [@@bs.obj]
  ...
  module NodeJS = {
    ...
    module ProcessVersions = {
      ...
      external make : electron::string => chrome::string => unit => t = "" [@@bs.obj]
    ...
    module ProcessMemoryInfo = {
      ...
      external make : workingSetSize::float => peakWorkingSetSize::float => privateBytes::float => sharedBytes::float => unit => t = "" [@@bs.obj]
    ...
    module SystemMemoryInfo = {
      ...
      external make : total::float => free::float => swapTotal::float => swapFree::float => unit => t = "" [@@bs.obj]
